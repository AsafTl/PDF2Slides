...
def get_grouped_text_blocks(raw_ocr_result, max_vertical_dist=200):
    ...
    for line in raw_ocr_result[0]:
        ...
        bboxes.append({'bbox': [x1, y1, x2, y2], 'text': text_conf[0], 'conf': text_conf[1]})
...
def test_custom_layout(image_path, out_path):
    print("Initializing raw PaddleOCR...")
...
if __name__ == "__main__":
    test_custom_layout(r"tests\craters\page_004.png", r"tests\craters\visualized_grouped_page_004.png")
